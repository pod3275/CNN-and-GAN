# -*- coding: utf-8 -*-
"""
Created on Wed Sep 25 16:19:31 2019
...
L1 = tf.contrib.layers.instance_norm(L1, center=True, scale=True)
L1 = tf.nn.relu(L1)
L1 = tf.nn.max_pool(L1, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')

W2 = tf.Variable(tf.random_normal([5, 5, 32, 64], stddev=0.01))
L2 = tf.nn.conv2d(L1, filter=W2, strides=[1, 1, 1, 1], padding='SAME')
L2 = tf.contrib.layers.instance_norm(L2, center=True, scale=True)
L2 = tf.nn.relu(L2)
