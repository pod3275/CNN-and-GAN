# -*- coding: utf-8 -*-
"""
Created on Thu Sep 26 21:05:45 2019
...
# separable convolution: depth-wise and point-wise
# channel: 32-->32
...
L2 = tf.nn.separable_conv2d(L1, depthwise_filter=depthwise_W2, pointwise_filter=pointwise_W2, strides=[1, 1, 1, 1], padding='SAME')
L2 = tf.nn.relu(L2)
